...
public class Client {
    ...
    public static boolean sendCommandObject(String line, String login, String password, Serializable obj){
    ...
    public static void sendCommand(String command, String login, String password){
        if(!Client.sendCommandObject(command, login, password, null)){
            connect();
            Client.sendCommandObject(command, login, password, null);
        }
    }
